/**
 * Converts a Google document to HTML and prepares an email
 * 
 * based on https://github.com/thejimbirch/GoogleDoc2Html
 */
function ConvertGoogleDocToCleanHtml(documentId) {
...
function convertToHtmlEmail(html, images) {
  var attachments = [];
